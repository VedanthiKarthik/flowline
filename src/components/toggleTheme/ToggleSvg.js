...
const ToggleSvgImg = () => {
    ...
    return (
        <>
            {/* <svg
                onClick={() => toggleTheme()}
                style={{ width: '24px', height: '24px', cursor: 'pointer' }} viewBox="0 0 24 24">
            ...
            <svg id="sun" className='theme-icon'
            ...
            <svg id="moon" className='theme-icon'
                onClick={() => setTheme(false)}
